...
public class VRC3CVRConvertConfigDrawer : PropertyDrawer
{
    class T
    {
        ...
        public static istring ConvertLocomotionTrackingControlDescription => new istring("Applies to everything folded into the locomotion layer, locomotion and Action alike. Tracking Control, common in VRChat's landing states, causes full-body tracking jitter in ChilloutVR when converted.", "locomotionレイヤーに畳み込まれるもの (locomotionとActionの両方) が対象です。VRChatの着地ステートにありがちなTracking Controlを変換するとCVRでFBTががたつく原因になります。");
